    ...
    <main>
        <article>
            ...
            <ul class=linksyear>
                ...
                <li><input type='checkbox' id='1914' name='1914' value='1914' class='linkyearbutton' checked />
                    <label for="1914">1914</label></li>
                <li><input type='checkbox' id='1915' name='1915' value='1915' class='linkyearbutton' checked />
                    <label for="1915">1915</label></li>
                <li><input type='checkbox' id='1916' name='1916' value='1916' class='linkyearbutton' checked/>
                    <label for="1916">1916</label></li>
                <li> <input type='checkbox' id='1917' name='1917' value='1917' class='linkyearbutton' checked/>
                    <label for="1917">1917</label></li>
                <li> <input type='checkbox' id='1918' name='1918' value='1918' class='linkyearbutton' checked/>
